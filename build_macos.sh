...
# Clone code from official Github repository
    rm -rf 
    git clone https://github.com/tourercoin/tourer.git
...
# Create zip file of binaries
    cp tourer/src/tourerd tourer/src/tourer-cli tourer/src/tourer-tx tourer/src/qt/tourer-qt tourer/Tourer-Core.dmg .
    zip -MacOS.zip tourerd tourer-cli tourer-tx tourer-qt Tourer-Core.dmg
    rm -f tourerd tourer-cli tourer-tx tourer-qt Tourer-Core.dmg
