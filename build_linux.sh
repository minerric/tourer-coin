...
# Create zip file of binaries
	cp tourer/src/tourerd tourer/src/tourer-cli tourer/src/tourer-tx tourer/src/qt/tourer-qt .
	zip -$(git describe --abbrev=0 --tags | sed s/v//)-Linux.zip tourerd tourer-cli tourer-tx tourer-qt
	rm -f tourerd tourer-cli tourer-tx tourer-qt
