...
/** Utility functions used by the Tourer Qt UI.
 */
namespace GUIUtil
{
...
// Render TOURER addresses in monospace font
...
// Parse "tourer:" URI into recipient object, return true on successful parsing
