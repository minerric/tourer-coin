...
/* Tourer GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Tourer"
#define QAPP_ORG_DOMAIN "tourer.org"
#define QAPP_APP_NAME_DEFAULT "Tourer-Qt"
#define QAPP_APP_NAME_TESTNET "Tourer-Qt-testnet"
