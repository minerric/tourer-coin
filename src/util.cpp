...
const char * const PIVX_CONF_FILENAME = "tourer.conf";
const char * const PIVX_PID_FILENAME = "tourer.pid";
const char * const PIVX_MASTERNODE_CONF_FILENAME = "masternode.conf";
const char * const PIVX_ACTIVE_MASTERNODE_CONF_FILENAME = "activemasternode.conf";


// Tourer only features
// Masternode
...
{
// Windows < Vista: C:\Documents and Settings\Username\Application Data\tourer
// Windows >= Vista: C:\Users\Username\AppData\Roaming\tourer
// Mac: ~/Library/Application Support/tourer
// Unix: ~/.tourer
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "tourer";
#else
    fs::path pathRet;
    ...
    std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty tourer.conf if it does not exist
    ...
    for (boost::program_options::detail::config_file_iterator it(streamConfig, setOptions), end; it != end; ++it) {
        // Don't overwrite existing settings so command line settings override tourer.conf
