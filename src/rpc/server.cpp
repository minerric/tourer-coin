...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* TOURER features */
        {"tourer", "listmasternodes", &listmasternodes, true },
        {"tourer", "getmasternodecount", &getmasternodecount, true },
        {"tourer", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"tourer", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"tourer", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"tourer", "masternodecurrent", &masternodecurrent, true },
        {"tourer", "startmasternode", &startmasternode, true },
        {"tourer", "createmasternodekey", &createmasternodekey, true },
        {"tourer", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"tourer", "listmasternodeconf", &listmasternodeconf, true },
        {"tourer", "getmasternodestatus", &getmasternodestatus, true },
        {"tourer", "getmasternodewinners", &getmasternodewinners, true },
        {"tourer", "getmasternodescores", &getmasternodescores, true },
        {"tourer", "mnsync", &mnsync, true },
        {"tourer", "spork", &spork, true },
...
{
    return "> tourer-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:28641/\n";
}
