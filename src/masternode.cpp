...
{
    if (nHeight >  1500000) return    100000 * COIN;
    if (nHeight >  1460000) return    100000 * COIN;
    if (nHeight >  1420000) return    100000 * COIN;
    if (nHeight >  1380000) return    100000 * COIN;
    if (nHeight >  1340000) return    100000 * COIN;
    if (nHeight >  1300000) return    100000 * COIN;
    if (nHeight >  1260000) return    100000 * COIN;
    if (nHeight >  1220000) return    100000 * COIN;
    if (nHeight >  1180000) return    100000 * COIN;
    if (nHeight >  1140000) return    100000 * COIN;
    if (nHeight >  1100000) return    100000 * COIN;
    if (nHeight >  1060000) return    100000 * COIN;
    if (nHeight >  1020000) return    100000 * COIN;
    if (nHeight >  980000) return     100000 * COIN;
    if (nHeight >  940000) return     100000 * COIN;
    if (nHeight >  900000) return     100000 * COIN;
    if (nHeight >  860000) return     100000 * COIN;
    if (nHeight >  820000) return     100000 * COIN;
    if (nHeight >  780000) return     100000 * COIN;
    if (nHeight >  740000) return     100000 * COIN;
    if (nHeight >  700000) return     70000 * COIN;
    if (nHeight >  660000) return     70000 * COIN;
    if (nHeight >  620000) return     70000 * COIN;
    if (nHeight >  580000) return     70000 * COIN;
    if (nHeight >  540000) return     50000 * COIN;
    if (nHeight >  500000) return     50000 * COIN;
    if (nHeight >  460000) return     50000 * COIN;
    if (nHeight >  420000) return     50000 * COIN;
    if (nHeight >  380000) return     30000 * COIN;
    if (nHeight >  340000) return     30000 * COIN;
    if (nHeight >  300000) return     30000 * COIN;
    if (nHeight >  260000) return     30000 * COIN;
    if (nHeight >  220000) return     20000 * COIN;
    if (nHeight >  180000) return     20000 * COIN;
    if (nHeight >  140000) return     20000 * COIN;
    if (nHeight >  100000) return     20000 * COIN;
    if (nHeight >  75000) return      10000 * COIN;
    if (nHeight >  50000) return      10000 * COIN;
    if (nHeight >  25000) return      10000 * COIN;
...
CAmount CMasternode::GetBlockValue(int nHeight)
{
    ...
    if(nHeight > 740000) return      140 * COIN;
    if(nHeight > 700000) return      360 * COIN;
    if(nHeight > 660000) return      280 * COIN;
    if(nHeight > 620000) return      240 * COIN;
    if(nHeight > 580000) return      200 * COIN;
    if(nHeight > 540000) return      240 * COIN;
    if(nHeight > 500000) return      140 * COIN;
    if(nHeight > 460000) return      120 * COIN;
    if(nHeight > 420000) return      100 * COIN;
    if(nHeight > 380000) return      120 * COIN;
    if(nHeight > 340000) return      100 * COIN;
    if(nHeight > 300000) return      90 * COIN;
    if(nHeight > 260000) return      80 * COIN;
    if(nHeight > 220000) return      50 * COIN;
    if(nHeight > 180000) return      40 * COIN;
    if(nHeight > 140000) return      30 * COIN;
    if(nHeight > 100000) return      20 * COIN;
    if(nHeight > 75000) return      50 * COIN;
    if(nHeight > 50000) return      40 * COIN;
    if(nHeight > 25000) return      30 * COIN;
    if(nHeight > 1000) return      10 * COIN;
    if(nHeight > 1) return          20 * COIN;
    if(nHeight > 0) return 100000000 * COIN;
...
bool CMasternodeBroadcast::CheckInputsAndAdd(int& nDoS)
{
    ...
    // should be at least not earlier than block when 1000 TOURER tx got MASTERNODE_MIN_CONFIRMATIONS
    ...
    if (mi != mapBlockIndex.end() && (*mi).second) {
        ...
        int nConfHeight = pMNIndex->nHeight + MASTERNODE_MIN_CONFIRMATIONS - 1; // block for 1000 TOURER tx -> 1 confirmation
