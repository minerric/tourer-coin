...
# Create zip file of binaries
	cp tourer/src/tourerd.exe tourer/src/tourer-cli.exe tourer/src/tourer-tx.exe tourer/src/qt/tourer-qt.exe .
	zip -Windows.zip tourerd.exe tourer-cli.exe tourer-tx.exe tourer-qt.exe
	rm -f tourerd.exe tourer-cli.exe tourer-tx.exe tourer-qt.exe
