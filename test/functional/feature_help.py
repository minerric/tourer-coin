...
"""Verify that starting tourer with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start tourer with -? for help text")
        ...
        self.log.info("Start tourer with -version for version information")
