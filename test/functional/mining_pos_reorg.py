...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected TOURER supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check TOURER supply at the beginning
        # ------------------------------------------
        # TOURER supply: block rewards minus burned fees for minting
        ...
        # Verify that TOURER supplies were properly updated after the spends and reorgs
        self.log.info("Check TOURER supply...")
