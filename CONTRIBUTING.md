Contributing to Tourer Core
============================

The Tourer Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Tourer Core project, and is not to be
confused with overall Tourer Network Protocol consensus changes.

Whether a pull request is merged into Tourer Core rests with the project merge
...
Patches that change Tourer consensus rules are considerably more involved than
...
Where a patchset proposes to change the Tourer consensus, it must have been
...
The project leader is the release manager for each Tourer Core release.
