...
#define MyAppName "Tourer Core"
#define MyAppPublisher "2022 DECENOMY Core Developers"
#define MyAppURL "https://www.tourer.io/"
#define MyAppExeName "tourer-qt.exe"
#define MyAppExtraData "https://explorer.tourer.io"
...
AppId={{91E6B988-10BA-444C-B18A-9A8721E69627}
AppName={#MyAppName}
...
OutputDir=.\output
OutputBaseFilename=TourerSetup
...
[Files]
Source: ".\package\tourer-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Tourer\Tourer-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Tourer\Tourer-Qt,strDataDir|{userappdata}\Tourer\}');
  Result := True;
end;
